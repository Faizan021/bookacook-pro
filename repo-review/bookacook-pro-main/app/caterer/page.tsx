      ...
      <section className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-24 md:grid-cols-2">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              href="/caterer/register"
              className="rounded-full bg-[#173f35] px-7 py-4 font-semibold text-white"
            >
              Speisely beitreten →
            </Link>
            ...
            <Link
              href="/login"
              className="rounded-full border border-[#d8ccb9] bg-white px-7 py-4 font-semibold text-[#173f35]"
            >
              Caterer-Login
            </Link>
          </div>
