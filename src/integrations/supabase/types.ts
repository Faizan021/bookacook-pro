...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      caterers: {
        Row: {
          accepts_inquiries: boolean | null;
          announcement_active: boolean;
          announcement_bg_color: string | null;
          announcement_text: string | null;
          approval_status: Database["public"]["Enums"]["partner_approval_status"] | null;
      ...
      restaurant_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "restaurant_orders_customer_profile_id_fkey";
    ...
    Enums: {
      ...
      order_status:
        ...
        | "delivered"
        | "cancelled";
      partner_approval_status: "pending" | "approved" | "rejected" | "suspended";
...
export const Constants = {
  ...
  public: {
    Enums: {
      ...
      review_role: ["restaurant", "caterer", "planner"],
      review_status: ["pending_moderation", "published", "flagged", "hidden"],
      seo_content_status: ["draft", "in_review", "approved", "published", "rejected", "archived"],
    },
  },
} as const;
