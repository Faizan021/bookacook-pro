      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="prose prose-forest max-w-none text-forest/80 space-y-6">
          ...
          <ul className="list-disc pl-5 space-y-2 mt-4">
            <li><strong>{tt("Projektname:", "Project name:")}</strong> Speisely</li>
            <li><strong>{tt("Webseite:", "Website:")}</strong> <a href="https://speisely.de" className="text-[#b28a3c] hover:underline">https://speisely.de</a></li>
            <li><strong>{tt("Kontakt:", "Contact:")}</strong> <a href="mailto:info@speisely.de" className="text-[#b28a3c] hover:underline">info@speisely.de</a></li>
          </ul>
          ...
          <p>
            ...
            <br />
            <a href="mailto:info@speisely.de" className="font-semibold text-[#b28a3c] hover:underline">info@speisely.de</a>
          </p>
