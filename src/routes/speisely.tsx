...
export const Route = createFileRoute("/speisely")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "https://speisely.de/speisely" }],
  }),
  ...
  const services = [
    {
      ...
      points: [
        t(
          "Direkter digitaler Bestellkanal für lokale Speisen",
          "Direct digital ordering channel for local spots",
        ),
        ...
        t(
          ...
          "Direct payouts to your own Stripe or PayPal account",
        ),
    ...
    },
    {
      ...
      points: [
        t(
          ...
          "Receive qualified catering requests from across Germany",
        ),
        t(
          "Kein Monatsabo – nur 10% Erfolgsgebühr bei Buchung",
          "No monthly subscription – only a 10% success fee on bookings",
        ),
        t(
          "Unterstützte Typen: Event-Catering, Firmenverpflegung, private Feiern",
          "Supports event catering, office lunches, and private parties",
        ),
        t(
          "Automatisierte Angebotserstellung und Kommunikation",
          "Automated proposal generation and client communication",
        ),
    ...
    },
    {
      ...
      points: [
        ...
        t(
          ...
          "Clients submit detailed event briefs (budget, date, guests)",
        ),
        t(
        ...
        t(
          ...
          "Manage vendors, track budgets, and communicate seamlessly",
        ),
        t(
          "Nur 10% Erfolgsgebühr bei bestätigter Buchung",
          "Only pay a 10% success fee when a booking is confirmed",
        ),
      ],
    },
  ];
  ...
  const targetAudience = [
    {
      ...
      desc: t(
        "Die einen direkten digitalen Bestellkanal zur besseren Kundenbindung suchen.",
        "Seeking a direct digital ordering channel to build closer customer relationships.",
      ),
    },
    {
      icon: <Utensils className="h-5 w-5" />,
      title: t("Caterer", "Caterers"),
      desc: t(
        "Die qualifizierte B2B- und B2C-Catering-Anfragen aus ganz Deutschland erhalten möchten.",
        "Looking to receive qualified B2B and B2C catering requests nationwide.",
      ),
    },
    {
      icon: <Calendar className="h-5 w-5" />,
      title: t("Event-Planer", "Event Planners"),
      desc: t(
        "Die Kunden für Firmenfeiern, Hochzeiten und private Veranstaltungen suchen.",
        "Searching for clients planning corporate events, weddings, and private functions.",
      ),
    },
    {
      ...
      desc: t(
        "Die zuverlässiges Catering für Büros, Team-Events und Offsites benötigen.",
        "Requiring reliable catering for offices, team events, and offsites.",
      ),
    },
    {
      icon: <Users className="h-5 w-5" />,
      title: t("Privatpersonen", "Individuals"),
      desc: t(
        "Die Catering für Geburtstage, Hochzeiten oder andere private Feiern suchen.",
        "Seeking catering for birthdays, weddings, or private celebrations.",
      ),
    },
    {
      icon: <MapPin className="h-5 w-5" />,
      title: t("Lokale Communities", "Local Communities"),
      desc: t(
        "Die lokale Restaurants und Caterer in ihrer Region entdecken und unterstützen möchten.",
        "Wanting to discover and support local restaurants and caterers.",
      ),
    },
  ];
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {services.map((s) => (
            <div key={s.title} className="surface-card p-8">
              ...
              <div className="text-[11px] font-semibold uppercase tracking-[0.15em] text-forest/50 mb-1">
                {s.subtitle}
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-16">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {regions.map((r) => (
            <span
              key={r}
              className="inline-flex items-center gap-1.5 rounded-full border border-forest/15 bg-cream px-4 py-1.5 text-sm text-forest font-medium"
            >
        ...
        <div className="grid gap-8 lg:grid-cols-2 max-w-4xl mx-auto">
          <div className="surface-card p-8">
            ...
            <div className="text-sm text-forest/70 mb-6">
              {t(
                "Pauschalabo — Unbegrenzte Bestellungen",
                "Flat-rate subscription — Unlimited orders",
              )}
            </div>
            <ul className="space-y-2">
              {[
          ...
          <div className="surface-card p-8">
            <div className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.15em] text-forest/50 mb-4">
              ...
              {t("Für Caterer & Event-Planer", "For Caterers & Event Planners")}
            </div>
            <div className="flex items-end gap-1 mb-2">
            ...
            <div className="text-sm text-forest/70 mb-6">
              {t(
                "Erfolgsgebühr — nur bei bestätigter Buchung",
                "Success fee — only when a booking is confirmed",
              )}
            </div>
            <ul className="space-y-2">
              {[
