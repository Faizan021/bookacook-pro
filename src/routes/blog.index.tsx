...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      { title: "Blog — Speisely" },
      { name: "description", content: "Insights, Trends und Tipps rund um Catering, Eventplanung und Food Delivery in Deutschland." }
    ],
  }),
  component: BlogIndex,
});
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-16 lg:py-24">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post) => (
            <Link
              ...
              onClick={() => trackEvent("blog_article_opened", { slug: post.slug, title: post.title.en })}
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <p className="text-sm text-forest/70 line-clamp-3 mb-6">
        ...
        <div className="mt-20 border-t border-forest/10 pt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/partners"
              onClick={() => trackEvent("partner_cta_clicked", { location: "blog_index_footer", role: "restaurant_owner" })}
            ...
            <Link
              to="/instant-order"
              onClick={() => trackEvent("nav_cta_clicked", { location: "blog_index_footer", destination: "instant-order" })}
              className="rounded-full bg-cream text-forest border border-forest/20 px-6 py-2.5 text-xs font-semibold hover:bg-forest hover:text-white transition"
            >
              {t("nav.instant")}
            </Link>
