...
const dict: Dict = {
  ...
  "ab.body": {
    de: "Ob spontane Essensbestellung bei Restaurants, Catering-Anfragen bei Caterern oder eine komplette Event-Planung mit professionellen Event-Planern: Die Suche nach dem passenden kulinarischen und organisatorischen Erlebnis sollte inspirierend sein, nicht kompliziert. Für unsere Partner schaffen wir faire Bedingungen: Restaurants zahlen ab 39,99 €/Monat bei 0 % Provision, während für Caterer und Event-Planer eine transparente, erfolgsbasierte Vermittlungsgebühr von 10 % gilt.",
    en: "Whether it is food ordering from local restaurants, catering requests for caterers, or complete event planning with professional event planners: the search for the perfect culinary and organizational experience should be inspiring, not complicated. For our partners, we create fair terms: restaurants pay from €39.99/month at 0% commission, while caterers and event planners pay a transparent, success-based matching fee of 10%.",
  },
  "ab.body.catering": {
