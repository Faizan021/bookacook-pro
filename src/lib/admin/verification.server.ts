export const SPEISELY_FEATURE_REGISTRY = {
  ...
  blocked_claims: [
    ...
    },
    {
      ...
      name: "Mobile App",
      reason: "Speisely is a responsive web platform, but does not have a native iOS/Android mobile app."
    },
    {
    ...
    },
    {
      ...
      reason: "We offer event planner inquiries and catering, but not a daily corporate meal calendar/planner software."
    },
    {
    ...
    },
    {
      ...
      reason: "Speisely handles catering subscriptions, but not individual D2C meal prep subscriptions."
    },
    {
