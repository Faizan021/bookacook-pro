...
*   **Display / Headings Font**: `Fraunces` (fallback: Georgia, serif).
    *   *Usage*: Page titles, hero section headlines, section headings, and display numbers.
    *   *Tailwind Class*: `font-display` (e.g. `font-display text-5xl font-bold`)
*   **Body / UI Font**: `Inter` (fallback: system-ui, sans-serif).
    *   *Usage*: Paragraphs, input fields, labels, buttons, and navigation links.
    *   *Tailwind Class*: `font-sans` (default body font)
