...
// Simple .env parser
const env = fs.readFileSync('C:/recoverd usb/Speisely Marketplace1/.env', 'utf8')
  .split('\n')
  .reduce((acc, line) => {
...
async function verifyPipeline() {
  ...
  if (!supabaseUrl || !anonKey || !serviceKey) {
    console.error("Missing environment variables.", { supabaseUrl: !!supabaseUrl, anonKey: !!anonKey, serviceKey: !!serviceKey });
    process.exit(1);
  }
